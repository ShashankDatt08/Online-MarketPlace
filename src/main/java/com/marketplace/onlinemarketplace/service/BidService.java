...
public class BidService {
    ...
    /**
     * Deletes all bids older than the given date.
     * @param date the cutoff date; bids created before this date will be removed
     */
    public void deleteBidsByDate(Date date) {
        LocalDateTime cutoff = Instant.ofEpochMilli(date.getTime())
